...
return [
    ...
    */
    ...
    | Isso permite especificar rapidamente uma linha de idioma personalizada
    | para uma regra de validação específica de um atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para substituir o placeholder
    | do atributo por algo mais amigável, como "Endereço de E-Mail" em vez
    | de "email". Isso simplesmente ajuda a tornar nossas mensagens mais
    | expressivas.
    |
    */
